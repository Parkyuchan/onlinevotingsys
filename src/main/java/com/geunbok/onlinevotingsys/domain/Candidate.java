...
public class Candidate extends BaseTimeEntity {
    ...
    @Builder
    public Candidate(String department, String name_candidate1, String id_candidate1, String name_candidate2, String id_candidate2,
                     String gongyak) {
    ...
    public void update(String department, String name_candidate1, String name_candidate2, String gongyak) {
        this.department = department;
        this.name_candidate1 = name_candidate1;
        this.name_candidate2 = name_candidate2;
        this.gongyak = gongyak;
